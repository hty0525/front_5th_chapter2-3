...
type SelectTriggerProps<T> = ButtonHTMLAttributes<T> & ElementBaseProps<T>

export const SelectTrigger = ({ className, children, ...props }: SelectTriggerProps<HTMLButtonElement>) => (
...
type SelectContentProps<T> = SelectPrimitive.SelectContentProps & ElementBaseProps<T>
...
export const SelectContent = ({
  ...
  position = "popper",
  ...props
}: SelectContentProps<HTMLDivElement>) => (
...
type SelectItemProp<T> = SelectPrimitive.SelectItemProps & ElementBaseProps<T>

export const SelectItem = ({ className, children, ...props }: SelectItemProp<HTMLDivElement>) => (
