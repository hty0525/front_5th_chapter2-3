...
type DialogProps = ElementBaseProps<HTMLDivElement>
type DialogTitleProps = ElementBaseProps<HTMLHeadingElement>
...
export const DialogContent = ({ className, children, ...props }: DialogProps) => (
  <DialogPortal>
